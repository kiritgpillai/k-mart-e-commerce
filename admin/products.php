...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      if($image_size > 2000000){
         ...
         $insert_product = $conn->prepare("INSERT INTO `products`(pid,name, category, price, image) VALUES(?,?,?,?,?)");
         $insert_product->execute([$pid,$name, $category, $price, $image]);
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <h3>add product</h3>
      <input type="number" min="0" max="9999999999" required placeholder="enter product id" name="pid" onkeypress="if(this.value.length == 10) return false;" class="box"> <!-- changemade-->
